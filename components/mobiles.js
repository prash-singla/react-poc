...
var Mobiles = React.createClass({
  ...
  render: function() {
    return (<div className="wrapper">
    		<FilterBar folders={this.state.folders} onFilterSelect={this.filterItems}/>
    		<Body products={this.state.products} next={this.state.next} loadMore={this.loadMore} total={this.state.total}/>
