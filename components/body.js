   ...
   */
	_renderResultPages: function () {
		...
		for(var i = 1; i <= groups; i++) {
			pages.push(<ResultPage products={products.splice(lowerBound, upperBound)} pgNumber={i} total={this.state.total} sortBy={'rating_count-desc'} upperBound={upperBound} sort={this.onSortSelect}/>);
		}
      ...
      return (
      	<div className="filter-results">
			      ...
			      <div className="load-bar">
			        <a type="button" value="" onClick={this.props.loadMore}>Load More Products</a>
			      </div> : false
				  }
				</div>
    );
