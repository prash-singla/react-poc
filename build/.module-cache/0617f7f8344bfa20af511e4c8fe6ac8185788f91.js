var Body = React.createClass({displayName: "Body",
		...
		sort: function() {
			...
			console.log('value is ', this.refs.sortSelect.getDOMNode().value);
		},
        	...
        	React.createElement("div", {className: "filter-results"}, 
					  React.createElement("div", {className: "filter-results-head clearfix"}, 
					    React.createElement("select", {className: "sorter", onChange: this.sort, value: this.state.sortBy, ref: "sortSelect"}, 
					      React.createElement("option", {value: "popularity-desc", selected: "selected"}, 
					        "Popularity High - Low"
					      ), 
					      React.createElement("option", {value: "biq-score-desc"}, 
					        "IQ Score High - Low"
					      ), 
