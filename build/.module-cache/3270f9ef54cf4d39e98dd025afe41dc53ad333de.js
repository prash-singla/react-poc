...
var Mobiles = React.createClass({displayName: "Mobiles",
  ...
  /**
   * @ngdoc method
   * @name chatSecondaryTabsComponent#handleClick
   *
   * @description
   * handle the switching tabs
   */
  ...
  /**
   * @ngdoc method
   * @name chatSecondaryTabsComponent#loadMore
   *
   * @description
  ...
  /**
   * @ngdoc method
   * @name chatSecondaryTabsComponent#render
   *
   * @description
   * Renders chat Secondary Tabs
   *
   * @returns HTML to be rendered for the mobile page.
   */
  render: function() {
