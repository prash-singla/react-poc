var Body = React.createClass({displayName: "Body",
		...
		_renderResultPages: function () {
			...
			for(var i = 1; i <= groups; i++) {
				pages.push(React.createElement(ResultPage, {products: products.splice(lowerBound, upperBound), pgNumber: i, total: this.state.total, sortBy: 'rating_count-desc', lowerBound: lowerBound*i + upperBound, sort: this.sort}));
